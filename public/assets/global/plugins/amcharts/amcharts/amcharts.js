...
(function () {
    ...
    d.formatDataContextValue = function (a, b) {
        if (a) {
            ...
            for (e = 0; e < c.length; e++) {
                var h = c[e], h = h.substr(2, h.length - 4);
    ...
    d.parseDefs = function (a, b) {
        for (var c in a) {
            var e = typeof a[c];
            if (0 < a[c].length && "object" == e) for (var h =
                0; h < a[c].length; h++) e = document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[c][h], e); else "object" == e ? (e = document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[c], e)) : b.setAttribute(c, a[c])
        }
    }
})();
(function () {
    ...
    d.AxisBase = d.Class({
        construct: function (a) {
            ...
            this.periods = [{period: "ss", count: 1}, {period: "ss", count: 5}, {
                period: "ss",
                count: 10
            }, {period: "ss", count: 30}, {period: "mm", count: 1}, {
                period: "mm",
                count: 5
            }, {period: "mm", count: 10}, {period: "mm", count: 30}, {period: "hh", count: 1}, {
                period: "hh",
                count: 3
            }, {period: "hh", count: 6}, {period: "hh", count: 12}, {period: "DD", count: 1}, {
                period: "DD",
                count: 2
            }, {period: "DD", count: 3}, {period: "DD", count: 4}, {period: "DD", count: 5}, {
                period: "WW",
                count: 1
            }, {period: "MM", count: 1}, {period: "MM", count: 2}, {period: "MM", count: 3}, {
                period: "MM",
                count: 6
            }, {period: "YYYY", count: 1}, {period: "YYYY", count: 2}, {period: "YYYY", count: 5}, {
                period: "YYYY",
                count: 10
            ...
            if (a) {
                ...
                var g = h.width, h = h.height, k = this.viW, l = this.viH, m = 0, n = a.getBBox().height / 2,
                    p = this.inside, q = this.titleAlign;
        ...
        getBBox: function () {
            ...
            var a, b = this.chart, c = this.showFirstLabel, e = this.showLastLabel, h, f = "",
                g = d.extractPeriod(this.minPeriod), k = d.getPeriodDuration(g.period,
                g.count), l, m, n, p, q, r = this.firstDayOfWeek, t = this.boldPeriodBeginning;
            a = this.minorGridEnabled;
            var u, x = this.gridAlpha, A, w = this.choosePeriod(0), v = w.period, w = w.count,
            ...
            if (0 < this.gridCountR) for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
                ...
                this.pushAxisItem(m);
                m = l = q;
                if (!isNaN(u)) for (h = 1; h < w; h += u) this.gridAlpha = this.minorGridAlpha, f = q + A * h, f = d.resetDateToMin(new Date(f), v, u, r).getTime(),
            ...
            var b = d.getPeriodDuration(this.periods[a].period, this.periods[a].count),
                c = Math.ceil(this.timeDifference / b), e = this.periods;
...
(function () {
    ...
    d.ValueAxis = d.Class({
        inherits: d.AxisBase, construct: function (a) {
            ...
            if (this.logarithmic) {
                var e = this.treatZeroAs, h = this.getMin(0, this.data.length - 1);
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) e = !0; else {
                var m = this.labelFrequency, n = this.showFirstLabel, p = this.showLastLabel, q = 1;
                f = 0;
                ...
                var r = Math.round((this.maxCalc - this.minCalc) / this.step) + 1, t;
                ...
                var A, w = this.guides, v = w.length;
                if (0 < v) {
                ...
                var u = this.step, H, w = this.minorGridAlpha;
                this.minorGridEnabled && (H = this.getMinorGridStep(u, this.stepWidth * u));
                if ("date" == c) this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime = this.lastTime = this.max, this.startTime = this.firstTime = this.min, this.parseDatesDraw(); else for (r >= this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR =
                    this.autoRotateAngle), g = f; g < r; g += q) if (c = u * g + this.minCalc, h && this.max - this.min > 10 * this.min && (c -= this.min), c = d.roundTo(c, this.maxDecCount + 1), !this.integersOnly || Math.round(c) == c) if (isNaN(x) || Number(d.toFixed(c, x)) == c) {
                ...
                t = {type: "axisChanged", target: this, chart: a};
            ...
            "100% stacked" == b && (b = "100%");
            this.stackType = b;
            var c = [], e = [], h = [], f = [], g, k = this.chart.graphs, l, m, n, p, q = this.baseValue, r = !1;
            ...
            for (l = this.start; l <= this.end; l++) {
                var t = 0;
                for (p = 0; p < k.length; p++) if (n = k[p], n.hidden) n.newStack && (h[l] =
                    NaN, e[l] = NaN); else if (m = n.type, n.chart == this.chart && n.valueAxis == this && a == m && n.stackable) if (m = this.data[l].axes[this.id].graphs[n.id], g = m.values.value, isNaN(g)) n.newStack && (h[l] = NaN, e[l] = NaN); else {
            ...
            for (l = this.start; l <= this.end; l++) for (p = 0; p < k.length; p++) (n = k[p], n.hidden) ? n.newStack && (h[l] = NaN, e[l] = NaN) : (m = n.type, n.chart == this.chart && n.valueAxis ==
            ...
            var c, e;
            for (e = a; e <= b; e++) {
                var d = this.data[e].axes[this.id].graphs, f;
            ...
            for (b = this.start; b <= this.end; b++) {
                var c = this.data[b].axes[this.id].graphs, e;
            ...
            var c =
                {type: "axisZoomed", startValue: a, endValue: b, target: this, chart: this.chart};
            this.fire(c.type, c)
        }, zoomOut: function () {
            var a = this.chart;
            ...
            var c = this.chart;
            "xy" == c.type ? (b < a && (c = b, b = a, a = c), a < this.min && (a = this.min), b > this.max && (b = this.max), c = {type: "axisSelfZoomed"}, c.chart = this.chart, c.valueAxis = this, c.multiplier = this.axisWidth / Math.abs(this.getCoordinate(b) - this.getCoordinate(a)), c.startValue = a, c.endValue =
            ...
            if (isNaN(a)) return NaN;
            var b = this.rotate, c = this.reversed, e = this.axisWidth, d = this.stepWidth, f = this.min,
                g = this.minReal;
    ...
    d.RecAxis = d.Class({
        construct: function (a) {
            var b = a.chart, c = a.axisThickness, e = a.axisColor, h = a.axisAlpha, f = a.offset, g = a.dx, k = a.dy,
                l = a.viX, m = a.viY, n = a.viH, p = a.viW, q = b.container;
...
(function () {
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, n, p) {
            ...
            l || (l = 0);
            void 0 == e && (e = !0);
            var r = q.fontFamily, t = a.fontSize;
            void 0 == t && (t = q.fontSize);
            var u = a.color;
            void 0 == u && (u = q.color);
            void 0 !== n && (u = n);
            var x = a.chart.container, A = x.set();
            this.set = A;
            var w = a.axisThickness, v = a.axisColor, z = a.axisAlpha, B = a.tickLength, D = a.gridAlpha,
                C = a.gridThickness, L = a.gridColor, H = a.dashLength, J = a.fillColor, I = a.fillAlpha,
                W = a.labelsEnabled;
            n = a.labelRotationR;
            var ea = a.counter, Q = a.inside, oa = a.labelOffset, qa = a.dx, ka = a.dy, Ra = a.orientation,
                ca = a.position, aa = a.previousCoord, V = a.viH, sa = a.viW, ba = a.offset, da, ta;
            ...
            var S = n * Math.PI / 180, X, ya, E = 0, y = 0, la = 0, ga = X = 0, Ja = 0;
            "V" == Ra && (n = 0);
            var Z;
            ...
            Z && (Z.attr({"text-anchor": fa}), Z.translate(E, y,
    ...
    d.AmChart = d.Class({
        construct: function (a) {
            ...
            if (this.container && !1 !== a.enabled) {
                ...
                var b = a.y, c = a.text, e = a.align, h = a.size, f = a.color, g = a.rotation, k = a.alpha, l = a.bold,
                    m = d.toCoordinate(a.x, this.realWidth), b = d.toCoordinate(b, this.realHeight);
                m || (m = 0);
                b || (b = 0);
                void 0 === f && (f = this.color);
        ...
        animate: function (a, b, c, e, h, f, g) {
            ...
            if (this.animations) for (a = this.animations.length - 1; 0 <= a; a--) {
                var b = this.animations[a], c = 1E3 * b.time / d.updateRate,
                    e = b.frame + 1, h = b.obj, f = b.attribute;
                if (e <= c) {
                    b.frame++;
        ...
        construct: function (a) {
            ...
            for (d = this.start; d <= this.end; d++) {
                var f = this.data[d].axes[c.id].graphs[this.id],
                    g = f.values, k = g.x, l = g.y, g = c.getCoordinate(k), m = e.getCoordinate(l);
            ...
            for (m = this.start; m <= this.end; m++) {
                var n = this.data[m].axes[this.valueAxis.id].graphs[this.id], p, q;
                "none" == a || "3d" ==
                ...
                if (isNaN(p)) this.connect || (this.drawLineGraph(b, c, e, d), b = [], c = [], e = [], d = []); else {
                    var r = this.y - (this.valueAxis.getCoordinate(p) - this.height),
                        r = r * this.valueAxis.rMultiplier, t = 180 - 360 / (this.end - this.start + 1) * m;
                    ...
                    if (!isNaN(q)) {
                        var u = this.y - (this.valueAxis.getCoordinate(q) - this.height),
                            ...
                            x = u * Math.sin(t / 180 * Math.PI), t = u * Math.cos(t / 180 * Math.PI);
                        e.push(x);
                        d.push(t);
                        isNaN(k) && (k = x);
                        isNaN(l) && (l = t)
            ...
            if (e) {
                var l = e.graphDataItem,
                    m = this.chart.rotate, n = l.isNegative, p = this.chart, q = this.valueAxis;
                b -= k.height / 4 / 2;
                switch (g) {
                    case "top":
                ...
                var r = l.columnGraphics, t = 0, u = 0;
                r && (t = r.x, u = r.y);
            ...
            var a = this.chart, b = this.id, c = this.index, e = this.data, h = this.chart.container,
                f = this.valueAxis, g = this.type, k = this.columnWidthReal,
                l = this.showBulletsAt;
            isNaN(this.columnWidth) || (k = this.columnWidth);
            isNaN(k) && (k = .8);
            var m = this.useNegativeColorIfDown, n = this.width, p = this.height, q = this.y, r = this.rotate,
                t = this.columnCount, u = d.toCoordinate(this.cornerRadiusTop, k / 2), x = this.connect, A = [], w = [],
                v, z, B, D, C = this.chart.graphs.length, L, H = this.dx / this.tcc, J = this.dy / this.tcc,
                I = f.stackType, W = this.start, ea = this.end, Q = this.scrollbar, oa = "graph-column-";
            Q && (oa = "scrollbar-graph-column-");
            var qa = this.categoryAxis, ka = this.baseCoord, Ra = this.negativeBase,
                ca = this.columnIndex, aa = this.lineThickness, V = this.lineAlpha, sa = this.lineColorR,
                ba = this.dashLength, da = this.set, ta, fa = this.getGradRotation(), S = this.chart.columnSpacing,
                X = qa.cellWidth, ya = (X * k - t) / t;
            S > ya && (S = ya);
            var E, y, la, ga = p + 1, Ja = n + 1, Z = 0, qb = 0, rb, sb, eb, fb, tb = this.fillColorsR,
                Ka = this.negativeFillColors, Da = this.negativeLineColor, Wa = this.fillAlphas,
            ...
            if (!(Q || "line" != g && "smoothedLine" != g && "step" != g || (1 == e.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), !Ka && void 0 == Da || m))) {
                ...
                var Ga = f.getCoordinate(Sa), Kb = f.getCoordinate(f.max);
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g) {
                if (0 < W) {
                    for (K = W - 1; -1 < K; K--) if (E = e[K], y = E.axes[f.id].graphs[b], la = y.values.value, !isNaN(la)) {
                        W = K;
                        break
                    }
                    if (this.lineColorField) for (K =
                                                      W; -1 < K; K--) if (E = e[K], y = E.axes[f.id].graphs[b], y.lineColor) {
                        this.bulletColorSwitched = this.lineColorSwitched = y.lineColor;
                        break
                    }
                    if (this.fillColorsField) for (K = W; -1 < K; K--) if (E = e[K], y = E.axes[f.id].graphs[b], y.fillColors) {
                        this.fillColorsSwitched = y.fillColors;
                        break
                    }
                    if (this.dashLengthField) for (K = W; -1 < K; K--) if (E = e[K], y = E.axes[f.id].graphs[b], !isNaN(y.dashLength)) {
                        this.dashLengthSwitched = y.dashLength;
                        break
                    }
                }
                if (ea < e.length - 1) for (K = ea + 1; K < e.length; K++) if (E = e[K], y = E.axes[f.id].graphs[b], la = y.values.value, !isNaN(la)) {
                    ea =
                        K;
                    break
                }
            ...
            var Mb = this.noStepRisers, hb = -1E3, ib = -1E3, jb = this.minDistance, Ma = !0, Ya = !1, ub = 0, vb = 0;
            for (K = W; K <= ea; K++) {
                E = e[K];
                y = E.axes[f.id].graphs[b];
                y.index = K;
                var Za, Na = NaN;
                if (m && void 0 == this.openField) for (var wb = K + 1; wb < e.length && (!e[wb] || !(Za = e[K + 1].axes[f.id].graphs[b]) || !Za.values || (Na = Za.values.value, isNaN(Na))); wb++) ;
                var R, P, M, ha, ma = NaN, G = NaN, F = NaN, O =
                        NaN, N = NaN, Oa = NaN, Ea = NaN, Pa = NaN, Fa = NaN, ua = NaN, va = NaN, ia = NaN, ja = NaN,
                    Y = NaN, xb = NaN, yb = NaN, na = NaN, pa = void 0, Ia = tb, Ta = Wa, Ba = sa, wa, za,
                    zb = this.proCandlesticks, kb = this.topRadius, $a = this.pattern;
                ...
                if (Ca) {
                    ...
                    var ma = E.x[qa.id], Ua = this.periodSpan - 1, ra = Math.floor(X / 2) + Math.floor(Ua * X / 2),
                        Aa = ra, lb = 0;
                    ...
                    switch (g) {
                        case "line":
                            if (isNaN(Y)) x || (this.drawLineGraph(A, w, T, U), A = [], w = [], T = [], U = []); else {
                            ...
                            break;
                        case "smoothedLine":
                            if (isNaN(Y)) x || (this.drawSmoothedGraph(A, w, T, U), A = [], w = [], T = [], U = []); else {
                                if (Math.abs(G -
                        ...
                        case "column":
                            ...
                            if (!isNaN(Y)) {
                                ...
                                d.setCN(a, pa.set, y.className, !0), y.columnGraphics = za, za.translate(R, P), this.columnsSet.push(za), (y.url || this.showHandOnHover) && za.setAttr("cursor", "pointer"), !Q)) {
                                    ...
                                    this.columnsArray.push({column: pa, depth: L});
                                    y.x = r ? P + M / 2 : R + M / 2;
                        ...
                        case "ohlc":
                            if (!(isNaN(na) || isNaN(xb) || isNaN(yb) || isNaN(Y))) {
                                ...
                                var mb, nb, ob;
                                if (r) {
                                    var Fb = F - k / 2, Fb = d.fitToBounds(Fb, 0, p), Rb = d.fitToBounds(F, 0, p),
                                        Gb = F + k / 2, Gb = d.fitToBounds(Gb, 0, p);
                                    ...
                                    var Hb = G - k / 2, Hb = d.fitToBounds(Hb, 0, n), Sb = d.fitToBounds(G, 0, n),
                                        Ib = G + k / 2, Ib = d.fitToBounds(Ib, 0, n);
                    ...
                    if (!Q && !isNaN(Y)) {
                        ...
                        if (this.end - this.start <= Tb || 0 === Tb) {
                            var Ub = this.createBullet(y, ia, ja, K), Vb = this.labelText;
                            if (Vb && Ub) {
                                var Jb =
                            ...
                            if ("regular" == I || "100%" == I) {
                                ...
                                if (Wb) {
                                    ...
                                    var Xb = Qa.getBBox(), Yb = Xb.width, Zb = Xb.height, bb, cb,
                                        pb = f.totalTextOffset, $b = f.totals[K];
                                    $b && $b.remove();
                                    var db = 0;
            ...
            var h = this;
            if (1 < a.length) {
                var f = h.set, g = h.chart, k = h.container, l = k.set(), m = k.set();
                f.push(m);
                f.push(l);
                var n = h.lineAlpha, p = h.lineThickness, f = h.fillAlphas, q = h.lineColorR, r = h.negativeLineAlpha;
                isNaN(r) && (r = n);
                var t = h.lineColorSwitched;
                t && (q = t);
                var t = h.fillColorsR, u = h.fillColorsSwitched;
                u && (t = u);
                var x = h.dashLength;
                (u = h.dashLengthSwitched) && (x = u);
                var u = h.negativeLineColor,
                    A = h.negativeFillColors, w = h.negativeFillAlphas, v = h.baseCoord;
            ...
            if (1 < a.length) {
                ...
                var m = this.lineAlpha,
                    n = this.lineThickness, h = this.dashLength, p = this.fillAlphas, q = this.lineColorR,
                    r = this.fillColorsR, t = this.negativeLineColor, u = this.negativeFillColors,
                    x = this.negativeFillAlphas, A = this.baseCoord, w = this.lineColorSwitched;
                w && (q = w);
            ...
            var a = this.chart, b = this.set, c = this.bulletSet,
                e = this.x, d = this.y;
            b.show();
            c.show();
            ...
            b && (this.rotate ? (b.translate(-1E3, d), c.translate(-1E3, d)) : (b.translate(e, -1E3), c.translate(e, -1E3)), b.animate({
                opacity: 1,
                translate: e + "," + d
            }, f, a), c.animate({opacity: 1, translate: e + "," + d}, f, a))
        }, animate: function (a) {
            ...
            if (!isNaN(b) && !isNaN(c)) {
                ...
                var k = a.values.value, l = this.maxValue,
                    m = this.minValue, n = this.maxBulletSize, p = this.minBulletSize;
                ...
                q ? (q.size = g || 0, a.bulletGraphics = q) : q = {size: 0};
                q.graphDataItem = a;
                return q
            }
            ...
            if (a) {
                ...
                if (e) {
                    var e = c.formatString(this.balloonText, a, !0), h = this.balloonFunction;
                    h && (e = h(a, a.graph));
                    e = d.cleanFromEmpty(e);
...
(function () {
    ...
    d.ChartCursor = d.Class({
        construct: function (a) {
            ...
            var a = this.chart, b = this.cursorAlpha, c = a.categoryAxis, e = this.categoryBalloon, h, f, g, k;
            g = a.dx;
            k = a.dy;
            var l = this.width, m = this.height, n = a.rotate;
            ...
            var a = this.cursorAlpha, b = this.container,
            ...
            if (a) if (a.mouseIsOver) {
                ...
                -.5 < b && b < this.width + 1 && 0 < c && c < this.height ? ((this.valueLineEnabled || this.valueLineBalloonEnabled) && this.updateVLine(b, c), this.setPosition(), this.drawing ? this.rolledOver || a.setMouseCursor("crosshair") :
            ...
            var c = this.vLine, e = this.vaBalloon;
            if ((c || e) && !this.panning && !this.drawing) {
                c && c.show();
                var d = this.valueLineAxis, f, g = this.rotate;
            ...
            var a = this.chart, b = a.mouseX - this.x, c = a.mouseY - this.y, e = this.vLine, h = this.hLine,
                b = d.fitToBounds(b, 0, this.width), c = d.fitToBounds(c, 0, this.height);
            ...
            var c = this.selectionPosX, e = this.selectionPosY, h = 0, f = 0, g = this.width, k = this.height;
            isNaN(a) || (c > a &&
            ...
            var a = this.valueBalloons, b = this.x, c = this.y, e = this.height + c;
            ...
            a.reverse();
            var b, c = this.x, e, d, f = a.length;
            for (d = 0; d < f; d++) {
                var g = a[d].balloon;
                b = g.bottom;
                var k = g.bottom - g.yPos, l = f - d - 1;
            ...
            for (c = 0; c < b.length; c++) {
                ...
                if (!e.hidden && e.balloonText) {
                    var h = this.data[this.index].axes[e.valueAxis.id].graphs[e.id], f = h.y;
                    if (!isNaN(f)) {
                        var g, k;
                        g = h.x;
            ...
            var e = this.chart, h = this.fullWidth, f = e.mouseX - this.x, g = e.mouseY - this.y;
            ...
            if (this.enabled) {
                ...
                var k = e.categoryAxis,
                    l = e.dx, m = e.dy, n = this.x + 1, p = this.y + 1, q = this.width, r = this.height,
                    t = this.data[a], u;
                this.data[a + 1] && (u = this.data[a + 1]);
                this.fireMoved();
                if (t) {
                    var x = t.x[k.id], A = e.rotate, w = this.stepWidth, v = this.categoryBalloon, z = this.firstTime,
                        B = this.lastTime, D = this.cursorPosition, C = this.zooming, L = this.panning, H = e.graphs;
                    if (e.mouseIsOver || C || L || this.forceShow) if (this.forceShow = !1, L) {
                        b = this.panClickPos;
                        a = this.panClickEndTime;
                        var e = this.panClickStartTime, C = this.panClickEnd, J = this.panClickStart,
                            f = (A ? b - g : b - f) / w;
                        if (!k.parseDates ||
                        ...
                        if (A) {
                            if (0 > x) if (C) x = 0; else {
                                this.hideCursor();
                                return
                            }
                            if (x > r + 1) if (C) x = r + 1; else {
                                this.hideCursor();
                                return
                            }
                        } else {
                            ...
                            if (x > q) if (C) x = q; else {
                                this.hideCursor();
                                return
                            }
                        }
                        z = this.line;
                        0 < this.cursorAlpha && (A ? (B = 0, w = x + m, h && (w -= k.cellWidth / 2)) : (B = x, w = 0, h && (B -= k.cellWidth / 2)), D = this.animationDuration, 0 < D && !this.zooming ? isNaN(this.previousX) ? z.translate(B, w) : (z.translate(this.previousX, this.previousY), z.animate({translate: B + "," + w}, D, "easeOutSine")) : z.translate(B, w), this.previousX = B, this.previousY = w, z.show());
                        ...
                        if (!c && (a != this.previousIndex || J != this.previousMostCloseGraph) && (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], H && this.valueBalloonsEnabled && B && e.balloon.enabled)) {
                            ...
                            for (k = 0; k < H.length; k++) if (v = H[k], z = NaN, (!this.oneBalloonOnly || v == J) && v.showBalloon && !v.hidden && v.balloonText && ("step" == v.type && "left" == v.stepDirection && (t = this.data[a + 1]), t)) {
                                if (u = t.axes[v.valueAxis.id].graphs[v.id]) z = u.y;
                                "top" == v.showBalloonAt && (z = 0);
                                "bottom" ==
                                v.showBalloonAt && (z = this.height);
                                if (this.showNextAvailable && isNaN(z) && a + 1 < this.data.length) for (B = a + 1; B < this.data.length; B++) if (x = this.data[B]) if (u = x.axes[v.valueAxis.id].graphs[v.id], z = u.y, !isNaN(z)) break;
                                if (!isNaN(z)) {
                                    x = u.x;
                                    w = !0;
                                    if (A) {
                        ...
                        b ? (b = {type: "changed"}, b.index = a, b.chart = this.chart, b.zooming = C, b.mostCloseGraph = J, b.position = A ? g : f, b.target = this, e.fire("changed", b), this.fire("changed", b), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, e.updateLegendValues(a));
            ...
            var d = b.position,
                f = b.inside;
            b = b.axisThickness;
            var g = this.chart, k = g.dx, g = g.dy, l = this.x, m = this.y, n = this.width, p = this.height;
            ...
            var e = b.position, d = b.inside, f = b.axisThickness, g = b.tickLength,
                k = this.chart, l = k.dx, k = k.dy, m = this.x, n = this.y, p = this.width, q = this.height;
            ...
            var a = this.chart, b =
                this.data, c;
            if (a) {
                var e = a.mouseX - this.x, h = a.mouseY - this.y;
                if (this.drawingNow) {
                    this.drawingNow = !1;
                ...
                if (this.enabled && 0 < b.length) {
                    if (this.pan) this.rolledOver = !1; else if (this.zoomable && this.zooming) {
                        ...
                        if ("cursor" == this.type) this.rotate ?
                            ...
                            var g = this.initialMouseX, k = this.initialMouseY;
            ...
            if (this.zoomable || this.pan || this.drawing) {
                var b = this.rotate, c = this.chart, e = c.mouseX - this.x, h = c.mouseY - this.y;
    ...
    d.SimpleChartScrollbar = d.Class({
        construct: function (a) {
            ...
            if (a.enabled) {
                ...
                if ((a.height = g) && f) {
                    ...
                    var n = d.rect(b, l, m, "#000", .005), p = d.rect(b, l, m, "#000", .005);
            ...
            if (k) {
                c =
                    k.x + d;
                e = k.y + f;
                var l = k.width, k = k.height, m = this.rotate, n = this.chart, p = this.width, q = this.height,
                    r = n.mouseX, t = n.mouseY;
                a = this.initialMouse;
            ...
            if (this.skipEvent) this.skipEvent = !1; else {
                var a = this.chart;
                a.hideBalloon();
                var b = this.getDBox(), c = b.x, e = b.y, d = b.width, b = b.height;
                this.rotate ? (c = e, d = this.height / b) : d = this.width / d;
                a = {type: "zoomed", position: c, chart: a, target: this, multiplier: d};
                this.fire(a.type, a)
            }
        }, updateDragIconPositions: function () {
            var a = this.getDBox(), b = a.x, c = a.y, e = this.iconLeft, d = this.iconRight, f, g,
        ...
        removeCursors: function () {
            ...
            if (!a.resizingRight &&
                ...
                a.updateOnReleaseOnly ? (a.skipEvent = !1, h.setAttr(b, c), a.dispatchScrollbarEvent(), a.clipDragger()) : (c = Math.round(c), m ? h.animate({y: c}, e, ">") : h.animate({x: c}, e, ">"), a.forceClip = !0, clearTimeout(a.forceTO), a.forceTO = setTimeout(function () {
        ...
        inherits: d.SimpleChartScrollbar, construct: function (a) {
            ...
            if (a.enabled) {
                ...
                var b = a.chart, c = b.chartData, e = a.categoryAxis, h = a.rotate, f = a.x, g = a.y, k = a.width,
                    l = a.height, m = b.categoryAxis, n = a.set;
                e.setOrientation(!h);
                ...
                e.zoom(0, c.length - 1);
                if (m = a.graph) {
                    var p = a.valueAxis, q = m.valueAxis;
                    p.id = q.id;
                    p.rotate = h;
                    p.setOrientation(h);
                    p.width = k;
                    ...
                    var f = Infinity, g = -Infinity, r;
                    for (r = 0; r < c.length; r++) {
                        var t = c[r].axes[q.id].graphs[m.id].values, u;
                        for (u in t) if (t.hasOwnProperty(u) && "percents" != u && "total" != u) {
                            var x = t[u];
                            x < f && (f = x);
                            x > g && (g = x)
                        }
            ...
            if (this.skipEvent) this.skipEvent = !1; else {
                ...
                b = e.x;
                var d = e.y, f = e.width, e = e.height, g = this.chart;
                this.rotate ? (b = d, c = e) : c = f;
                f = {type: "zoomed", target: this};
                f.chart = g;
                var k = this.categoryAxis, l = this.stepWidth, d = g.minSelectedTime, e = !1;
    ...
    d.AmBalloon = d.Class({
        construct: function (a) {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    var g = this.l, k = this.t, l = this.r, m = this.b, n = this.balloonColor, p = this.fillColor,
                        q = this.borderColor, r = p;
                    void 0 != n && (this.adjustBorderColor ? r = q = n : p = n);
                    var t = this.horizontalPadding, u = this.verticalPadding, x = this.pointerWidth,
                        A = this.pointerOrientation, w = this.cornerRadius, v = c.fontFamily, z = this.fontSize;
                    ...
                    D < g && (D = g);
                    D + C > l && (D = l - C);
                    var k = z + u, m = D + t, u = this.shadowAlpha, H = this.shadowColor, t = this.borderThickness,
                        J = this.bulletSize, I;
                    ...
                    0 < this.animationDuration && !e && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY), f.animate({
                        translate: D - h + "," +
                            z
                    }, b, "easeOutSine"), n && (B.left = this.prevTX + "px", B.top = this.prevTY + "px", this.xAnim = c.animate({node: n}, "left", this.prevTX, m, b, "easeOutSine", "px"), this.yAnim = c.animate({node: n}, "top", this.prevTY, k, b, "easeOutSine", "px")));
                    this.prevX = D - h;
                    this.prevY = z;
                    this.prevTX = m;
                    this.prevTY = k
...
(function () {
    ...
    d.AmCoordinateChart = d.Class({
        ...
        createValueAxes: function () {
            ...
            var b = this.graphs, c, e = {}, h = this.seriesIdField;
            h || (h = this.categoryField);
            this.chartData = [];
            if (a) {
                var f = !1, g, k = this.categoryAxis, l, m, n;
            ...
            var e;
            for (e = 0; e < b.length; e++) {
                var d = b[e], f = this.lookupTable[String(d[c])], g = a.valueAxis.id;
        ...
        processValueAxes: function () {
            ...
            if (!this.legend.data && a) {
                var c = a.hidden, e = a.showBalloon;
                switch (b) {
                    case "clickMarker":
...
(function () {
    ...
    d.AmSlicedChart = d.Class({
        inherits: d.AmChart, construct: function (a) {
            ...
            var b = a.type, c = a.dataItem, e = this.legend;
            if (!e.data && c) {
                var d = c.hidden;
                a = a.event;
                switch (b) {
            ...
            a.started = !0;
            var b = a.wedge, c = this.startDuration, e = a.labelSet;
            ...
            !0 === c && (e = 0);
            if (c = a.wedge) 0 < e ? (c.animate({translate: b * a.pullX + "," + b * a.pullY}, e, this.pullOutEffect), a.labelSet && a.labelSet.animate({translate: b * a.pullX + "," + b * a.pullY}, e, this.pullOutEffect)) : (a.labelSet && a.labelSet.translate(b * a.pullX, b * a.pullY), c.translate(b * a.pullX, b * a.pullY));
        ...
        pullInAll: function (a) {
            ...
            for (c = 0; c < a.length; c++) {
                var e = a[c], h = this.formatString(this.labelText, e), f = this.labelFunction;
                f && (h = f(e, h));
...
(function () {
    ...
    d.AmRectangularChart = d.Class({
        inherits: d.AmCoordinateChart, construct: function (a) {
            ...
            this.updateDxy();
            var a = !0;
            !this.marginsUpdated && this.autoMargins && (this.resetMargins(), a =
                !1);
            ...
            var a = this.valueAxes, b, c = this.autoMarginOffset, e = this.fixMargins, d = this.realWidth,
                f = this.realHeight, g = c, k = c, l = d;
            b = f;
            var m;
            ...
            if (!a.zbSet) {
                ...
                var c = a.color, e = a.fontSize, h = a.zoomOutButtonImageSize,
                    f = a.zoomOutButtonImage.replace(/\.[a-z]*$/i, ""), g = d.lang.zoomOutText || a.zoomOutText,
            ...
            var a = this.dx, b = this.dy, c = this.marginLeftReal, e = this.marginTopReal, h = this.plotAreaWidth - 1,
                f = this.plotAreaHeight -
                    1, g = this.plotAreaFillColors, k = this.plotAreaFillAlphas, l = this.plotAreaBorderColor,
            ...
            var a = this.valueAxes, b = this.marginLeftReal, c = this.marginTopReal, e = this.plotAreaHeight,
                h = this.plotAreaWidth, f;
            ...
            var c = a.position, e = a.scrollbarHeight + a.offset;
            ...
            if (a) {
                a.rotate = b;
                var c = this.marginTopReal, e = this.marginLeftReal,
                    d = a.scrollbarHeight, f = this.dx, g = this.dy, k = a.offset;
    ...
    d.TrendLine = d.Class({
        construct: function (a) {
            ...
            var b = a.chart, c = b.container, e, h, f, g, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory,
                n = a.finalDate, p = a.finalCategory, q = a.valueAxis, r = a.valueAxisX, t = a.initialXValue,
                u = a.finalXValue, x = a.initialValue, A =
                    a.finalValue, w = q.recalculateToPercents, v = b.dataDateFormat;
...
(function () {
    ...
    d.polygon = function (a, b, c, e, h, f, g, k, l, m, n) {
        ...
        void 0 === g && (g = p);
        h = {fill: p, stroke: g, "fill-opacity": h, "stroke-width": f, "stroke-opacity": k};
    ...
    d.rect = function (a, b, c, e, h, f, g, k, l, m, n) {
        ...
        r += d.dx;
        t += d.dy;
        h = {fill: p, stroke: g, "fill-opacity": h, "stroke-opacity": k};
        void 0 !== n && 0 < n && (h["stroke-dasharray"] = n);
    ...
    d.bullet = function (a, b, c, e, h, f, g, k, l, m, n, p) {
        ...
        switch (b) {
            ...
            case "rectangle":
                q = d.polygon(a, [-c,
                    c, c, -c], [c / 2, c / 2, -c / 2, -c / 2], e, h, f, g, k, m - 180);
                break;
            case "diamond":
    ...
    d.makeHD = function (a, b, c) {
        for (var e = [], d = [], f = 1; f < a.length; f++) for (var g = Number(a[f - 1]), k = Number(b[f - 1]), l = Number(a[f]), m = Number(b[f]), n = Math.sqrt(Math.pow(l - g, 2) + Math.pow(m - k, 2)), n = Math.round(n / 50) + 1, l = (l - g) / n, m = (m - k) / n, p = 0; p <= n; p++) {
            var q = g + p * l + Math.random() * c, r = k + p * m + Math.random() * c;
            e.push(q);
            d.push(r)
        }
        return [e, d]
    ...
    d.handDrawnLine = function (a, b, c, e, h, f, g, k, l, m) {
        var n, p = a.set();
        for (n = 1; n < b.length; n++) for (var q = [b[n - 1], b[n]], r = [c[n - 1], c[n]], r = d.makeHD(q, r, a.handDrawScatter), q = r[0], r = r[1], t = 1; t < q.length; t++) p.push(d.line(a, [q[t - 1], q[t]], [r[t - 1], r[t]], e, h, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, k, l, m, !0));
        return p
    };
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, p, q) {
        ...
        g = r(g);
        k = r(k);
        var t = r(g / f * k), u = d.VML, x = 359.5 + f / 100;
        359.94 < x && (x = 359.94);
        h >= x &&
        (h = x);
        var A = 1 / 180 * Math.PI, x = b + Math.sin(e * A) * k, w = c - Math.cos(e * A) * t,
            v = b + Math.sin(e * A) * f, z = c - Math.cos(e * A) * g, B = b + Math.sin((e + h) * A) * f,
            D = c - Math.cos((e + h) * A) * g, C = b + Math.sin((e + h) * A) * k, A = c - Math.cos((e + h) * A) * t,
            L = {fill: d.adjustLuminosity(m.fill, -.2), "stroke-opacity": 0, "fill-opacity": m["fill-opacity"]}, H = 0;
        180 < Math.abs(h) && (H = 1);
        e = a.set();
        var J;
...
(function () {
    ...
    d.Bezier = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m) {
            ...
            var d = Math.round, f = this.getPointOnSegment(a, b, .75), g = this.getPointOnSegment(e, c, .75),
                k = (e.x - a.x) / 16, l = (e.y - a.y) / 16, m = this.getPointOnSegment(a, b, .375);
...
(function () {
    ...
    d.AmDraw = d.Class({
        construct: function (a, b, c, e) {
            ...
            d.VML && (h = Math.round(100 * h / Math.min(c, e)), c += 2 * f, e += 2 * f, k.bw = f, k.node.style.marginLeft =
    ...
    d.VMLRenderer = d.Class({
        ...
        text: function (a, b, c) {
            ...
            for (h = 0; h < b.length; h++) {
                ...
                "Z" == g && (a += " x e");
                if ("Q" == g) {
                    var m = c.length, n = c[m - 1], p = k[0], q = k[1], l = k[2], r = k[3];
                    c = d(c[m - 2] / 3 + 2 / 3 * p);
                    n = d(n / 3 + 2 / 3 * q);
                    p = d(2 / 3 * p + l / 3);
                    q = d(2 / 3 * q + r / 3);
        ...
        set: function (a) {
            ...
            for (f = 0; f < c.length; f++) {
                var g = Math.round(100 * f / (c.length - 1)), h = h + (g + "% " + c[f]);
                f < c.length - 1 && (h += ",")
            }
            a = a.fill;
    ...
    d.SVGRenderer = d.Class({
        construct: function (a) {
            ...
            for (a = b.length - 1; 0 <= a; a--) {
                var c = b[a], e = 1E3 * c.time / d.updateRate, h = c.frame + 1, f = c.obj, g = c.attribute, k, l, m;
    ...
    d.AmLegend = d.Class({
        construct: function (a) {
            ...
            var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, e = this.marginTop,
                h = this.marginBottom, f = this.horizontalGap,
                g = this.div, k = this.divWidth, l = this.maxColumns, m = this.verticalGap, n = this.spacing,
                p = k - c - b, q = 0, r = 0, t = this.container;
            this.set && this.set.remove();
            var u = t.set();
            this.set = u;
            var x = t.set();
            u.push(x);
            var A = this.entries, w, v;
            ...
            if (!1 !== a.visibleInLegend) {
                ...
                var l = this.container, m = this.markerSize, n = 0, p = 0, q = m / 2;
                if (this.useGraphSettings) {
                    ...
                    if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c) g = l.set(), a.hidden || (e = a.lineColorR, f = a.bulletBorderColorR), n = d.line(l, [0, 2 * m], [m / 2, m / 2], e, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(b, n, "graph-stroke"), g.push(n), a.bullet && (a.hidden || (e = a.bulletColorR),
                        n = d.bullet(l, a.bullet, a.bulletSize, e, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (d.setCN(b, n, "graph-bullet"), n.translate(m + 1, m / 2), g.push(n)), q = 0, n = m, p = m / 3; else {
                        var r;
...
(function () {
    ...
    d.stringToDate = function (a, b) {
        var c = {}, e = [{pattern: "YYYY", period: "year"}, {pattern: "YY", period: "year"}, {
            ...
            pattern: "HH",
            period: "hours"
        }, {pattern: "H", period: "hours"}, {pattern: "KK", period: "hours"}, {
            pattern: "K",
            period: "hours"
        }, {pattern: "LL", period: "hours"}, {
            pattern: "L",
            period: "hours"
        }, {pattern: "NN", period: "minutes"}, {pattern: "N", period: "minutes"}, {
            pattern: "SS",
            period: "seconds"
        }, {pattern: "S", period: "seconds"}, {pattern: "QQQ", period: "milliseconds"}, {
            pattern: "QQ",
            period: "milliseconds"
        }, {pattern: "Q", period: "milliseconds"}], h = !0, f = b.indexOf("AA");
    ...
    d.formatDate =
        function (a, b, c) {
            ...
            var p = String(e).substr(2, 2), q = h + 1;
            9 > h && (q = "0" + q);
            var r = "0" + g;
            b = b.replace(/W/g, n);
            n = k;
